...
*Project Title
Sudoku Solver Using C Programming (Backtracking Algorithm)
...
This C program allows the user to:
 ...
 Let the program solve the puzzle automatically using backtracking. Display the solved puzzle OR show a message if no solution exists.
...
Example puzzle entry by user:

Row 1: 3 0 0 0 2 0 0 7 0
Row 2: 9 0 0 5 0 0 0 1 4
Row 3: 0 1 6 3 7 0 0 0 8
Row 4: 2 0 0 8 0 0 0 0 1
Row 5: 5 0 0 0 4 1 8 0 0
Row 6: 0 8 9 0 0 0 0 5 0
Row 7: 0 0 5 0 1 0 2 8 0
Row 8: 0 4 0 0 0 6 0 9 3
Row 9: 7 3 1 0 8 2 0 0 0

*Sample Output

Solved Sudoku:
To see the output view screenshots attached in the repository

If the puzzle has no valid solution:
No valid solution exists for this puzzle.

*Screenshots
screenshots1.jpg — User Input
screenshot2.jpg — Solved Sudoku Output
